...
<!--[if lt IE 9]>
	...
	<%
		...
		List<Rank> ranklist = dao.queryAll();
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">
							<i class="icon_table"></i>RANK CHANGE
						</h3>
						<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-lg-6">
						<form class="input-group" action="/ESMS/Emquery" method='post'>
							<input type="hidden" name='type' value='rch' /> <input
														...
														<tr>
															...
															<td>
																<div class="btn-group">
																	...
																	<!-- 模态框 -->
																	<form method="post" action="/ESMS/Rankch"
																			...
																			<div class="modal-dialog">
																				<div class="modal-content">
																					...
																					<div class="modal-body">
																						...
																						<div class="form-group ">
																							<label for="departch" class="control-label col-lg-2">员工部门
																							</label>
																							<div class="col-lg-10">
																								<input class="form-control" id="departch" name="departch"
																						...
																						<div class="form-group ">
																							...
																							<div class="col-lg-10">
																								<select name="rnamech" id="rnamech"
